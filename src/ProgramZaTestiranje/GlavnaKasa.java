...
● String tacanOdgovor // identican sa jednim od prijasnih odgovora
        ...
        Pitanje p6 = new PitanjeSaPonudjenimOdgovorima("Pitanje sa ponudjenim odg", 13,
        ...
        for (Pitanje p : listaPitanja){
            System.out.print(p);
            p.setOdgovorStudenta(sc.nextLine());
        }
        ...
        System.out.println(" Imate ukupno osvojenih poena na testu: " + suma);
    }
}
